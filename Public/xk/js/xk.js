...
$(function() {
	...
	// $(document).click(function(){
     ...
     //        $('#div-qzxfdhk').hide();
     //    });
	$('#div-qzxfdhk').click(function(event){event.stopPropagation(); });
	$(document).click(function(){ $('#ul-select-bld').hide(); });
	$('#ul-select-bld').click(function(event){event.stopPropagation(); });
	$('#div-select-bld1').click(function(event){event.stopPropagation(); });
        ...
        if ($li.length > 0) {
            ...
            $("body").on("keydown", "#in1", function () {
                if (event.keyCode == 38) {
                    if (a != 0 && a != -1) {
                        a--;
                        $(".marketing-control-search-room-list li").eq(a).css({'fontWeight': "bold", 'backgroundColor': 'pink'}).attr("on", "1");
                        $(".marketing-control-search-room-list li").not($(".marketing-control-search-room-list li").eq(a)).css({'fontWeight': "normal", 'backgroundColor': '#FFF'}).attr("on", "0");
                        ;
                    }
	...
	$(".marketing-control-search-room-list, .marketing-control-title").mouseleave(function() {
        ...
        //搜索客户
	$(".search-input-kh").bind('input propertychange', function() { 
