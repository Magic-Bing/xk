...
$.fn.casmenu = function(opts) {
	...
	if (typeof(AI.opts.saveinput) != "undefined" 
		&& (AI.opts.saveinput = AI.opts.saveinput.toString()) != ''
	) {
	...
	$("body").on("change", ".casmenu", function() {
		...
		//levels对象中不存在下一级别目录
		if (typeof(AI.opts.levels[level]) == "undefined") {
			return;
		}

		//获取下一级别目录的键值，值不存在的话返回
		var name = $(this).find("option:selected").attr("name");
		if (typeof(AI.opts.levels[level][name]) == "undefined") {
			return;
		}

		if (typeof(AI.opts.ulObj['level_'+level]) == "undefined" 
			|| typeof(AI.opts.ulObj['level_'+level][name]) == "undefined"
		) {
			if (typeof(AI.opts.ulObj['level_'+level]) == "undefined") {
