        ...
        <div class="show_content_m_t2">
            <div style="display:block;float:left;line-height: 38px;background: #eff3f8;width:100%;padding:0 0 3px 0">
               ...
               <select id= "companylist" name="companylist" style="padding: 1px 10px;height:25px;" >
                ...
                <form method="post" id="selectcomp"  action="<?php echo U('/Account/Yhqxstation/index');?>"  style="display:none">
                        ...
                        <div id="con_one_1">
                            <div class="table_td" style="">
								...
								<i class="icon-edit bigger-120"></i>
                                                    ...
                                                    <div class="xzuserdiv"  onclick="xzuser(<?php echo ($station_vo['id']); ?>,<?php echo ($station_vo['cp_id']); ?>)" >选用户</div>
                                                </td> 
                                            </tr><?php endif; ?>
                                            <?php else: ?>
                                            ...
                                            <tr class="tr_c" onmouseover="this.bgColor='#F5F5F5';" onmouseout="this.bgColor='#ffffff';" bgcolor="#ffffff" stationid="<?php echo ($station_vo['id']); ?>" data_id="<?php echo ($i); ?>" projid="<?php echo ($station_vo['proj_id']); ?>">
                                                 <td align="left" style="padding: 0 0 0 25px;">
                                                  ...
                                                  <td align="center" style="height:35px"> 
                                                    <a style="margin-right: 5px;" class="edit_station_btn" pid="<?php echo ($station_vo['proj_id']); ?>" href="javascript:void(0);" title="编辑" >
                                                        <span style="padding: 3px 3px;background-color: #6fb3e0;color: #FFF;">
								<i class="icon-edit bigger-120"></i>
                                                         </span>
                                                    </a>
                    ...
                    <div id="con_one_1">
                        <div class="table_td" style="">
                            <table border="0" cellspacing="2" cellpadding="4" class="list" name="table1" id="table1" width="100%">
                                ...
                                <?php if(is_array($userlist)): foreach($userlist as $key=>$userinfo_vo): ?><tr class="s_out"  bgcolor="#ffffff" id="trid_<?php echo ($userinfo_vo['id']); ?>"> 
                                        <td align="center"><?php echo ($userinfo_vo['username']); ?></td> 
                                        <td align="center"> <?php echo ($userinfo_vo['code']); ?> </td> 
                                        <td align="center"> <?php echo ($userinfo_vo['mobile']); ?> </td>
                                        <td align="center" style="height: 35px;">
                                            <a onclick="stationdeluser(<?php echo ($userinfo_vo['station_id']); ?>,<?php echo ($userinfo_vo['id']); ?> )" title="删除">
...
<div class="user_edit_div">
    ...
    $("#companylist").change(function(){
     ...
     $(".tr_c").click(function(){
      ...
      {
            $("#bldtb").html("");
            var project_url = {getuserist: '<?php echo U("getuserist");?>',}		
            $.ajax({
        ...
        function stationdeluser($stationid,$id)
        {
            ...
            var project_url = {stationdeluser: '<?php echo U("stationdeluser");?>',}
            $.ajax({
            ...
            function stationadduser()
            {
                    ...
                    var project_url = {stationadduser: '<?php echo U("stationadduser");?>',}	
                    $.ajax({
